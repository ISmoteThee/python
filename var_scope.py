...
my_function(argument_variable="I am an argument variable.")
...
try:
    ...
    print(error)
print("\nTrying to access argument_variable outside of its function...")
try:
    print(argument_variable)
except NameError as error:
    print(error)
print("\nTrying to access module_variable outside of its function...")
try:
